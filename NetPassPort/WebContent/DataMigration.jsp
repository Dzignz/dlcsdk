...
<script type="text/javascript" src="js/migration/mogan.migration.function.js"></script>
<script type="text/javascript" src="js/migration/mogan.migration.form.js"></script>
<script type="text/javascript" src="js/migration/mogan.migration.init.js"></script>
