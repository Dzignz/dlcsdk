...
createLoadBidItemsParams = function(store, startIndex,
	...
	var loadParams = {
		params : {/*
			...
			STATUS_CONDITION : statusCondition,
			CONDITION : ''*/
			appid:'1hyQM_.xg64UN1RnE406vvWL2JJQK1iqB57THqGXVNPTLIXK7HY.zXvrsntRkQM-',
			query:'ipod'
		},
		add : false,
		scope : store,
...
loadBidItemsData=function (records,options,success){
	//alert('loadBidItemsData');
}
